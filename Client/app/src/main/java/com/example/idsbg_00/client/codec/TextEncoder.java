...
public class TextEncoder extends ProtocolEncoderAdapter {
    private static final AttributeKey ENCODER = new AttributeKey(TextEncoder.class, "encoder");
     ...
     */
    public TextEncoder(String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public TextEncoder(LineDelimiter delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public TextEncoder(Charset charset, String delimiter) {
     ...
     * and the specified <tt>delimiter</tt>.
     */
    public TextEncoder(Charset charset, LineDelimiter delimiter) {
        if (charset == null) {
