...
class Binding {
    ...
    fun boxIDCreateFirstRequest(macId: String): String {
        val boxID = ""
        ...
        call.enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                if (null != response.cacheResponse()) {
                    ...
                    boxIdCreateSecondRequest(boxId,macId)
                    saveBoxId(boxId)
    ...
    fun saveBoxId(boxId: String): String {
        return boxId
    }
    ...
    companion object {
            ...
            call.enqueue(object : Callback {
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    if (null != response.cacheResponse()) {
                        ...
                        passCreateThirdRequest(pass,macId)
                        //                    Log.d("结果", "network---" + str);
                    }
                }
            })
        ...
        private fun passCreateThirdRequest(pass: String,macId: String) {
            val MEDIA_XML_APPLICATIOON = MediaType.parse("application/xml;charset=utf-8")
